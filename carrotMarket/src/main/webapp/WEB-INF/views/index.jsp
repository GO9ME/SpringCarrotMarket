	...
	<section class="home-main">
		...
		<div class="home-main__item background-beige">
			<div class="item-box top--box">
				...
				<div class="item-box__img top--img">
					<img src="/resources/images/phono-image-1.png"
						alt="phone-image-1" class="desktop" /> <img
						src="/resources/images/phono-image-1.png"
		...
		<div class="home-main__item">
			<div class="item-box">
				<div class="item-box__img">
					<img src="/resources/images/phono-image-2.png"
						alt="phono-image-2" />
				</div>
		...
		<div class="home-main__item background-green">
			<div class="item-box">
				<div>
					...
					<div class="item-box__list">
						<div class="item-box__item">
							<img src="/resources/images/icon-story-1.svg"
								alt="icon-story-1" />
							<h3>우리동네질문</h3>
							<p>
						...
						<div class="item-box__item">
							<img src="/resources/images/icon-story-2.svg"
								alt="icon-story-2" />
							<h3>동네분실센터</h3>
							<p>
						...
						<div class="item-box__item">
							<img src="/resources/images/icon-story-3.svg"
								alt="icon-story-3" />
							<h3>우리동네질문</h3>
							<p>
				...
				<div class="item-box__img">
					<img src="/resources/images/phono-image-3.png"
						alt="phono-image-3" />
				</div>
			</div>
		</div>
		...
		<div class="home-main__item">
			<div class="item-box">
				<div class="item-box__img">
					<img src="/resources/images/phono-image-4.png"
						alt="phono-image-4" />
				</div>
				<div class="item-box__container">
					<article class="item-box__text">
		...
		<div class="home-popular__list">
			<div class="popular-list">
				<div class="popular-list__item">
					<img src="/resources/images/popular-sale-1.jpeg"
				...
				<div class="popular-list__item">
					<img src="/resources/images/popular-sale-2.jpeg"
				...
				<div class="popular-list__item">
					<img src="/resources/images/popular-sale-3.jpeg"
				...
				<div class="popular-list__item">
					<img src="/resources/images/popular-sale-4.jpeg"
				...
				<div class="popular-list__item">
					<img src="/resources/images/popular-sale-5.jpeg"
				...
				<div class="popular-list__item">
					<img src="/resources/images/popular-sale-6.jpeg"
				...
				<div class="popular-list__item">
					<img src="/resources/images/popular-sale-7.jpeg"
				...
				<div class="popular-list__item">
					<img src="/resources/images/popular-sale-8.jpeg"
